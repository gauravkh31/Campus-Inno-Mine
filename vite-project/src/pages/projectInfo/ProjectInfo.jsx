                        ...
                        <div className="w-full px-4 md:w-1/2">
                            <div className="lg:pl-20">
                                ...
                                <div className="mb-6">
                                    ...
                                    <p>Lorem ipsum dolor sit, amet consectetur, Jaipur</p>
                                </div>
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    ...
                                    <button
                                        className="w-full px-4 py-3 text-center text-white-600 bg-teal-500 border border-teal-600  hover:bg-teal-600 hover:text-gray-100 rounded-xl"
                                    >
                                        Thanks for Visit!!
                                    </button>
                                </div>
